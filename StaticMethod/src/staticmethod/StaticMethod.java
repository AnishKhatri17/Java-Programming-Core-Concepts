...
public class StaticMethod {
    ...
    public static void main(String[] args) {
       ...
       // StaticMethod.change();   //calling change method without use of object. Only changes the static variable when this is called; 
        StaticMethod s1 = new StaticMethod("Anish Khatri",4);
        StaticMethod s2 = new StaticMethod("Sushil Bhandari",33);
        StaticMethod s3 = new StaticMethod("Junel Dhakal",28);
        StaticMethod s4 = new StaticMethod("Shirish Poudel",31);
        StaticMethod s5 = new StaticMethod("Sabin KC    ",25);
        s1.display();
        s2.display();
        s3.display();
        s4.display();
