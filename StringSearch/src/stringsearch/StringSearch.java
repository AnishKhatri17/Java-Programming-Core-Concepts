...
public class StringSearch {
    ...
    public static void main(String[] args) {
        ...
        String str = new String("Hello Dikshya");
        //int index = str.indexOf('z');   // The output will be -1 because the character 'z' is not found in the given String.
        int index = str.indexOf('i');   // Will be found at the given string and the output will be 7.
        System.out.println("The index of the letter D is : "+index);
    }  
}
/*
