...
public class ConstructorOverloading {
    ...
    public static void main(String[] args) {
        ...
        ConstructorOverloading xyz = new ConstructorOverloading("Sabin",29);
        ConstructorOverloading mno = new ConstructorOverloading(21,2077);
        ConstructorOverloading pqr = new ConstructorOverloading(14,"Junel");
        ConstructorOverloading A = new ConstructorOverloading("Anish",4,2077);
        Abc.display();
        xyz.display();
        mno.display();
        pqr.display();
